...
- Projects.
- Project detail command center with installed skills, editable per-skill policies, API keys, actionable update inbox, runtime calls, manageable subscription lifecycle, cost, invoice records, organization billing readiness, and next actions.
