...
- Shows a review repair loop that combines the latest exact version, reviewer notes, automated check evidence, structured blocker/advisory semantics, target fields, and concrete repair actions for rejected, blocked, warning, or unsubmitted versions.
