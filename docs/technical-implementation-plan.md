...
- Dashboard publisher account panel now lets publishers update their public profile name, submit PayPal/Alipay receiving details, and record payout readiness decisions while preserving existing restricted/suspended publisher status when no status change is requested.
