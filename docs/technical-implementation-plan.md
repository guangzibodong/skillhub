...
- The P0 release suite help and API reference now show the same two production modes, and the general smoke statically guards `docs/api.md` together with the 1Panel and QA runbooks so the routine public no-write gate and full protected Journey C gate cannot quietly drift apart.
