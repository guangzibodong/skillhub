...
type FooterTrustBrand = (typeof footerTrustBrands)[number];
...
const footerTrustLogoPaths: Record<FooterTrustBrand, string> = {
  openai:
  ...
  claude:
    "M4.709 15.955 9.43 13.308l.08-.23-.08-.128H9.2l-.79-.048-2.698-.073-2.339-.097-2.266-.122-.571-.121L0 11.784l.055-.352.48-.321.686.06 1.52.103 2.278.158 1.652.097 2.449.255h.389l.055-.157-.134-.098-.103-.097-2.358-1.596-2.552-1.688-1.336-.972-.724-.491-.364-.462-.158-1.008.656-.722.881.06.225.061.893.686 1.908 1.476 2.491 1.833.365.304.145-.103.019-.073-.164-.274-1.355-2.446-1.446-2.49-.644-1.032-.17-.619a2.97 2.97 0 0 1-.104-.729L6.283.134 6.696 0l.996.134.42.364.62 1.414 1.002 2.229 1.555 3.03.456.898.243.832.091.255h.158V9.01l.128-1.706.237-2.095.23-2.695.08-.76.376-.91.747-.492.584.28.48.685-.067.444-.286 1.851-.559 2.903-.364 1.942h.212l.243-.242.985-1.306 1.652-2.064.73-.82.85-.904.547-.431h1.033l.76 1.129-.34 1.166-1.064 1.347-.881 1.142-1.264 1.7-.79 1.36.073.11.188-.02 2.856-.606 1.543-.28 1.841-.315.833.388.091.395-.328.807-1.969.486-2.309.462-3.439.813-.042.03.049.061 1.549.146.662.036h1.622l3.02.225.79.522.474.638-.079.485-1.215.62-1.64-.389-3.829-.91-1.312-.329h-.182v.11l1.093 1.068 2.006 1.81 2.509 2.33.127.578-.322.455-.34-.049-2.205-1.657-.851-.747-1.926-1.62h-.128v.17l.444.649 2.345 3.521.122 1.08-.17.353-.608.213-.668-.122-1.374-1.925-1.415-2.167-1.143-1.943-.14.08-.674 7.254-.316.37-.729.28-.607-.461-.322-.747.322-1.476.389-1.924.315-1.53.286-1.9.17-.632-.012-.042-.14.018-1.434 1.967-2.18 2.945-1.726 1.845-.414.164-.717-.37.067-.662.401-.589 2.388-3.036 1.44-1.882.93-1.086-.006-.158h-.055L4.132 18.56l-1.13.146-.487-.456.061-.746.231-.243 1.908-1.312-.006.006Z",
  gemini:
...
function FooterTrustLogo({ brand }: { brand: FooterTrustBrand }) {
  return (
    <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24">
      <path d={footerTrustLogoPaths[brand]} />
    </svg>
  );
}
...
const homeLandingCopy = {
  en: {
    ...
    footerTrust: [
      ["ChatGPT / OpenAI", "Turn reviewed SkillHub workflows into reusable GPT actions so teams stop rebuilding research, analysis, and ops steps for every agent.", "Faster agent setup"],
      ["Claude / MCP", "Expose verified Skills through MCP with schemas and permissions intact, reducing tool setup time and review back-and-forth.", "Less tool wiring"],
      ["Gemini", "Chain research, SEO, data, and operations Skills into repeatable workflows so multi-step analysis moves from manual prompts to governed runs.", "Repeatable workflows"],
      ["GitHub Copilot", "Give coding teams versioned operational Skills for release checks, repo analysis, and handoffs, cutting repetitive engineering prep work.", "Less manual prep"],
    ],
    footerGroups: [
      {
        title: "Product",
  ...
  zh: {
    ...
    footerTrust: [
      ["ChatGPT / OpenAI", "把已审核的 SkillHub 工作流变成可复用的 GPT 调用能力，减少每个 Agent 反复搭研究、分析和运营步骤的时间。", "更快搭建 Agent"],
      ["Claude / MCP", "通过 MCP 暴露已验证技能，并保留 schema 与权限边界，减少工具配置和审核沟通成本。", "减少工具接线"],
      ["Gemini", "把研究、SEO、数据和运营技能串成可重复流程，让多步骤分析从手工提示变成受治理运行。", "流程可复用"],
      ["GitHub Copilot", "为研发团队提供版本化的发布检查、仓库分析和交接技能，减少重复工程准备工作。", "减少手工准备"],
    ],
    footerGroups: [
      {
        title: "产品",
