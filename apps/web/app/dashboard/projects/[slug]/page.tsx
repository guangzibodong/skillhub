...
const copy = {
  en: {
    ...
    readiness: {
      approved: [
        "Policy approval",
        "High-risk installs must be cleared before controlled invocation.",
      ],
      install: [
        "Skill installed",
        "At least one marketplace listing has become project state.",
      ],
      key: [
        "Runtime key ready",
        "A reveal-once project key exists for REST or MCP clients.",
      ],
      runtime: [
        "Runtime quality watched",
        "Recent calls are logged with status, latency, and error codes.",
      ],
      ...
      update: [
        "Update inbox",
        "Version updates and incidents need an explicit project decision.",
      ],
    },
    revoked: "Revoked",
  ...
  zh: {
    ...
    callsTitle: "最近运行调用",
    description:
      "管理这个智能体项目依赖的技能、运行密钥、预算、版本更新和调用质量信号。",
    empty: "暂无记录",
    eyebrow: "开发者项目",
    health: "项目健康",
    installed: "已安装技能",
    ...
    readiness: {
      approved: [
        "策略审批",
        "高风险安装必须先完成负责人确认，才能进入受控调用。",
      ],
      install: ["已有技能安装", "至少一个市场上架项已经变成项目状态。"],
      key: [
        "运行 Key 就绪",
        "已有一次性展示的项目 Key，可供 REST 或 MCP 客户端使用。",
      ],
...
> = {
  en: {
    ...
    body: "This queue turns the project detail into a daily command center: runtime keys, installed skills, owner approvals, version updates, runtime log, billing ledger state, and saved follow-ups stay ordered before the deeper panels.",
    eyebrow: "Project next actions",
    metrics: {
      installs: "Installed",
      keys: "Active keys",
      policy: "Policy gates",
    ...
    items: {
      ...
      billing:
        "A subscription period, renewal, or invoice row needs ledger record before paid runtime can be explained cleanly.",
      install:
        "No installed skill exists yet, so this project cannot prove that marketplace discovery became governed project state.",
      keys: "No active reveal-once project key exists for REST or MCP clients, so agents cannot connect safely yet.",
      policy:
      ...
      test: "The project has installed skills and an active key, but no runtime log yet. Run a controlled console test to create a log record.",
      updates:
  ...
  zh: {
    action: "\u6253\u5f00\u7b2c\u4e00\u4e2a\u52a8\u4f5c",
    body: "\u8fd9\u4e2a\u961f\u5217\u628a\u9879\u76ee\u8be6\u60c5\u9875\u53d8\u6210\u6bcf\u5929\u53ef\u7528\u7684\u6307\u6325\u53f0\uff1a\u8fd0\u884c Key\u3001\u5df2\u5b89\u88c5\u6280\u80fd\u3001\u8d1f\u8d23\u4eba\u5ba1\u6279\u3001\u7248\u672c\u66f4\u65b0\u3001\u8fd0\u884c\u8bc1\u636e\u3001\u8d26\u672c\u72b6\u6001\u548c\u5df2\u4fdd\u5b58\u540e\u7eed\u5de5\u4f5c\u90fd\u4f1a\u5728\u6df1\u5c42\u9762\u677f\u524d\u5148\u6392\u597d\u4f18\u5148\u7ea7\u3002",
    eyebrow: "\u9879\u76ee\u8fd0\u8425\u961f\u5217",
    metrics: {
      installs: "\u5df2\u5b89\u88c5",
      keys: "\u6d3b\u8dc3 Key",
    ...
    items: {
      ...
      keys: "\u8fd8\u6ca1\u6709\u6d3b\u8dc3\u7684\u4e00\u6b21\u6027\u5c55\u793a\u9879\u76ee Key\uff0cREST \u6216 MCP \u5ba2\u6237\u7aef\u6682\u65f6\u4e0d\u80fd\u5b89\u5168\u63a5\u5165\u3002",
      policy:
      ...
      test: "\u9879\u76ee\u5df2\u6709\u5b89\u88c5\u6280\u80fd\u548c\u6d3b\u8dc3 Key\uff0c\u4f46\u8fd8\u6ca1\u6709\u8fd0\u884c\u65e5\u5fd7\u3002\u5148\u8dd1\u4e00\u6b21\u6cbb\u7406\u6d4b\u8bd5\u6765\u4ea7\u751f\u8bc1\u636e\u3002",
      updates:
...
const projectAdjustmentCopy = {
  en: {
    body: "Read-only project history for finance adjustments. Finance operators still create and decide refunds or disputes from admin workflows, while developers can inspect the project impact here.",
    dispute: "Dispute",
    disputeStatuses: {
      lost: "Lost",
      open: "Open",
  ...
  zh: {
    body: "\u8fd9\u91cc\u662f\u9879\u76ee\u7ea7\u53ea\u8bfb\u8d22\u52a1\u8c03\u6574\u5386\u53f2\u3002\u9000\u6b3e\u6216\u4e89\u8bae\u4ecd\u7531\u8d22\u52a1\u5728\u7ba1\u7406\u540e\u53f0\u521b\u5efa\u548c\u51b3\u7b56\uff0c\u5f00\u53d1\u8005\u53ef\u4ee5\u5728\u8fd9\u91cc\u68c0\u67e5\u5b83\u5bf9\u672c\u9879\u76ee\u7684\u5f71\u54cd\u3002",
    dispute: "\u4e89\u8bae",
    disputeStatuses: {
      lost: "\u5df2\u8d25\u8bc9",
      open: "\u5904\u7406\u4e2d",
...
export default async function ProjectDetailPage({
  ...
  if (!hasProjectAccess) {
    return (
      ...
      >
        <div className={"project-detail-shell " + styles.pageStyles}>
          <section className="section">
            <div className="section-inner">
              <a
                className="inline-flex items-center gap-1 text-sm text-[#999] mb-4"
          ...
          <WorkspaceLockedPanel
            actionHref={localizedHref(
              hasWorkspaceSession ? "/account" : "/login",
              locale,
            )}
            actionLabel={
              hasWorkspaceSession
  ...
  const metrics = [
    ...
    [
      labels.budget,
      formatMoney(project.policy.monthlyBudgetCents, project.usage.currency),
      WalletCards,
    ],
    [labels.calls, formatCompactNumber(project.runtime.callCount), RadioTower],
    [
      labels.spend,
      formatMoney(project.usage.grossCents, project.usage.currency),
      CreditCard,
    ],
  ...
  const healthItems = [
    [
      labels.policyState,
      policyStateLabel(project.policy.state, locale),
      ShieldCheck,
    ],
    [labels.successRate, formatPercent(project.runtime.successRate), Gauge],
    [
      labels.avgLatency,
      formatLatency(project.runtime.avgLatencyMs, labels.noDate),
      Clock3,
    ],
    [
      labels.subscriptions,
      `${project.subscriptions.activeCount}`,
      CheckCircle2,
    ],
  ] as const;
  const readinessItems = getReadinessItems(detail, locale);
  const projectPriorityLabels = projectPriorityCopy[locale];
  const projectPriorityItems = buildProjectPriorityItems(
    detail,
    locale,
    projectRefunds,
    projectDisputes,
  ...
  const projectPriorityMetrics = [
    [
      projectPriorityLabels.metrics.keys,
      formatCompactNumber(project.apiKeys.activeCount),
      KeyRound,
    ],
    [
      projectPriorityLabels.metrics.installs,
      formatCompactNumber(project.installs.installedSkillCount),
      PackageCheck,
    ],
    [
      projectPriorityLabels.metrics.policy,
      formatCompactNumber(countProjectPolicyGates(detail)),
      ShieldCheck,
    ],
    [
      projectPriorityLabels.metrics.updates,
      formatCompactNumber(countOpenProjectUpdates(detail)),
      Clock3,
    ],
    [
      projectPriorityLabels.metrics.runtime,
      formatCompactNumber(countRuntimeQualityIssues(detail)),
      RadioTower,
    ],
  ] as const;
              ...
              {readinessItems.map((item) => (
                <div className="flex items-center gap-2 mt-2" key={item.label}>
                  <span className={item.ready ? "pill" : "pill pill--warning"}>
                    {item.ready
                      ? labels.readiness.ready
                      : labels.readiness.needsAction}
                  </span>
                  <div>
                    <b>{item.label}</b>
                    <small className="block text-xs text-[#999]">
                      {item.detail}
                    </small>
                  </div>
                </div>
        ...
        {hasProjectAccess ? (
          <>
            <section
              ...
              aria-labelledby="project-priority-heading"
            >
              <article className="card">
                <div>
                  ...
                  <h2 id="project-priority-heading">
                    {projectPriorityLabels.title}
                  </h2>
                  <p>{projectPriorityLabels.body}</p>

                  <div
                    className="flex flex-col gap-3 mt-4"
                    aria-label={projectPriorityLabels.queueLabel}
                  >
                    {projectPriorityItems.map((item) => (
                      ...
                      >
                        <span className="text-xs text-[#999]">
                          {projectPriorityLabels.tones[item.tone]} /{" "}
                          {item.metric}
                        </span>
                  ...
                  <a
                    ...
                    href={primaryProjectPriorityItem.href}
                  >
                      ...
                      {detail.recentInvocations.length > 0 ? (
                        detail.recentInvocations.map((call) => (
                          ...
                          >
                            ...
                            <span className={statusChipClass(call.status)}>
                              {call.status}
                            </span>
                            <span>
                              {formatLatency(call.latencyMs, labels.noDate)}
                            </span>
          ...
          <WorkspaceLockedPanel
            ...
            body={
              locale === "zh"
                ? "项目详情包含策略审批、API Key、运行测试、订阅和发票操作。当前会话缺少开发者权限，因此操作面板已隐藏，但仍可查看项目准入步骤和权限边界。"
                : "Project detail includes policy approval, API keys, runtime tests, subscriptions, and invoice operations. This session cannot operate them, but the locked state still shows the project access boundary."
            }
            locale={locale}
            projectSlug={project.slug}
            title={
      ...
      <article className="card">
        ...
        <div className="flex flex-col gap-3 mt-6" aria-label={guide.ariaLabel}>
          {guide.actions.map((action, index) => {
            const Icon =
              [LogIn, FolderPlus, SearchCheck][index] ?? ClipboardList;
            ...
            return (
              ...
              >
                ...
                <small className="block text-sm text-[#999] mt-1">
                  {action.body}
                </small>
              </a>
            );
...
function getProjectLockedGuide(locale: Locale, projectSlug: string) {
  if (locale === "zh") {
    return {
      ariaLabel: "项目详情准入步骤",
      eyebrow: "项目准入",
      marker: "项目待处理事项 / 策略审批 / API Key / 运行测试",
      actions: [
        {
        ...
        {
          body: `回到 ${projectSlug} 后创建 Key、检查策略，并运行受控测试。`,
          href: "/developer",
          label: "03",
          title: "回到项目运营",
        },
  ...
  return {
    ...
    marker:
      "project next actions / policy approval / API keys / runtime tests",
    actions: [
      {
...
function ProjectAdjustmentHistory({
  ...
  const rows = buildProjectAdjustmentRows(
    refunds,
    disputes,
    locale,
    noDateLabel,
            ...
            return (
              <section className="card card--compact" key={row.id}>
                <header className="flex items-center justify-between">
                  ...
                  <span className={statusChipClass(row.rawStatus)}>
                    {row.status}
                  </span>
                </header>
...
function getAgentSampleSkillSlug(detail: DeveloperProjectDetail) {
  return (
    detail.installedSkills.find(
      (skill) =>
        skill.status === "installed" && skill.verificationStatus === "verified",
    )?.skillSlug ??
    detail.installedSkills.find((skill) => skill.status === "installed")
      ?.skillSlug ??
...
function getReadinessItems(detail: DeveloperProjectDetail, locale: Locale) {
  ...
  const runtimeReady =
    ...
    (project.runtime.successRate === null ||
      project.runtime.successRate >= 0.95);
...
function buildProjectPriorityItems(
  ...
  const adjustmentActionCount = countProjectAdjustmentActions(
    refunds,
    disputes,
  );
  const savedFollowUpCount = detail.savedSkills.filter(
    (skill) => !skill.installedStatus || skill.installedStatus !== "installed",
  ).length;
  ...
  if (adjustmentActionCount > 0) {
    items.push({
      ...
      tone: hasDangerousProjectAdjustment(refunds, disputes)
        ? "danger"
        : "warning",
    });
  }
...
function countSuspendedProjectSignals(detail: DeveloperProjectDetail) {
  const projectSuspended =
    detail.project.policy.state === "suspended" ||
    detail.project.installs.suspendedInstallCount > 0
      ? 1
      : 0;
...
function countOpenProjectUpdates(detail: DeveloperProjectDetail) {
  const openRows = detail.updateInbox.filter(
    (update) =>
      !update.resolvedAt &&
      update.actionStatus !== "adopted" &&
      update.actionStatus !== "ignored",
  ).length;
...
function countProjectBillingActions(detail: DeveloperProjectDetail) {
  ...
  const invoiceActions = detail.invoices.filter(
    (invoice) =>
      !["paid", "void", "canceled", "cancelled"].includes(invoice.status),
  ).length;

  return subscriptionActions + invoiceActions;
}

function countProjectAdjustmentActions(
  refunds: RefundRecord[],
  disputes: DisputeRecord[],
) {
  const refundActions = refunds.filter((refund) =>
    ["approved", "failed", "requested"].includes(refund.status),
  ).length;
  const disputeActions = disputes.filter((dispute) =>
    ["lost", "open", "warning_needs_response"].includes(dispute.status),
  ).length;

  return refundActions + disputeActions;
}

function hasDangerousProjectAdjustment(
  refunds: RefundRecord[],
  disputes: DisputeRecord[],
) {
  return (
    refunds.some(
      (refund) => refund.status === "failed" || refund.status === "requested",
    ) ||
    disputes.some(
      (dispute) =>
        dispute.status === "lost" ||
...
function buildProjectAdjustmentRows(
  refunds: RefundRecord[],
  disputes: DisputeRecord[],
  locale: Locale,
  fallback: string,
  ...
  const rows = [
    ...refunds.map((refund) => ({
      ...
      reference:
        refund.adjustmentTransactionId ??
  ...
  return rows.sort(
    (first, second) =>
      adjustmentSortValue(second.createdAt) -
      adjustmentSortValue(first.createdAt),
  );
}
...
function statusChipClass(status: string) {
  if (
    ["error", "failed", "suspended", "revoked", "rejected", "blocked"].includes(
      status,
    )
  ) {
