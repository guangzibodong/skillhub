...
import { getPublicAppUrl } from "@/lib/api-url";
...
const opsCopy = {
  en: {
    ...
    apiRows: [
      ...
      [
        "Version pinning",
        "Agents can pin exact skill versions before execution",
      ],
      [
        "Webhook events",
        "Skill review, billing, payout, and runtime incident events",
      ],
    ],
...
const dashboardCommandCopy = {
  en: {
    actionOpen: "Open",
    body: "Use this page as the backend map: session state, role access, P0 journeys, and live operating signals are visible here while detailed work stays in the dedicated consoles.",
    ...
    cards: {
      account: {
        description:
          "Review login, connected identities, session fingerprints, notification preferences, and workspace readiness.",
      ...
      admin: {
        description:
          "Operate launch readiness, review, trust, incidents, identity, ledger, payouts, delivery, and audit.",
      ...
      developer: {
        description:
          "Manage agent projects, installed skills, runtime keys, policy approvals, governed tests, billing, team, and webhooks.",
        metric: "Projects",
      ...
      publisher: {
        description:
          "Operate skill drafts, exact-version review repair, pricing blockers, buyer demand, feedback, revenue, and payout readiness.",
        metric: "Owned skills",
  ...
  zh: {
    actionOpen: "打开",
    body: "这个页面是后台总入口：当前会话、角色入口、三条 P0 路径和实时发布状态都在这里可见；具体操作继续进入对应的开发者、发布者或管理员工作区。",
    eyebrow: "工作台总控",
    evidence: {
      launch: "上线阻断 / 警告",
      ledger: "账本行",
    ...
    cards: {
      ...
      admin: {
        description:
          "运营上线就绪、审核、信任、事故、身份、账本、提现、投递和审计。",
        metric: "就绪度问题",
        nextClear: "打开运营后台",
        nextIssues: "先清理上线阻断",
        role: "审核 / 财务 / 管理员",
      ...
      developer: {
        description:
          "管理 Agent 项目、已安装技能、运行 Key、策略审批、治理测试、账单、团队和 webhook。",
        metric: "项目数",
      ...
      publisher: {
        description:
          "运营技能草稿、精确版本审核修复、定价阻断、买方需求、反馈、收入和提现准备。",
        metric: "自有技能",
        nextEmpty: "开始发布流程",
        nextReady: "打开发布者工作台",
        role: "发布者 / 负责人",
...
const dashboardDemoChainCopy = {
  en: {
    action: "Open",
    allClear:
      "The visible demo chain has proof at every required stage. Keep clearing attention states in the dedicated workspaces before a customer walkthrough.",
    body: "This is the customer-demo proof path. It derives each stage from existing workspace, registry, review, runtime, ledger, payout, notification, and readiness state instead of inventing a fake task list.",
    ...
    steps: {
      publish: {
        detail:
          "Publisher supply starts as organization-scoped draft or owned skill state.",
        next: "Start from publish",
        title: "Publisher upload",
      },
      checks: {
        detail:
          "Exact versions carry review SLA and automated manifest/runtime/example/security evidence.",
        next: "Repair or submit versions",
        title: "Version submit and checks",
      },
      review: {
        detail:
          "Human review turns acceptable contracts into trusted marketplace supply.",
        next: "Open review operations",
        title: "Admin review gate",
      },
      listing: {
        detail:
          "Public listings connect verified supply to discovery, pricing, feedback, and publisher trust.",
        next: "Inspect marketplace",
        title: "Marketplace listing",
      },
      install: {
        detail:
          "Developers move catalog decisions into organization projects and pinned install state.",
        next: "Open developer projects",
        title: "Developer install",
      },
      runtime: {
        detail:
          "Project keys, policy, budget, subscription gates, REST, MCP, and console tests share one runtime path.",
        next: "Open runtime command",
        title: "Policy, key, and runtime test",
      },
      money: {
        detail:
          "Billable usage and subscriptions should produce immutable transactions, splits, balances, and payout readiness.",
        next: "Review ledger and payout",
        title: "Ledger and payout",
      },
      readiness: {
        detail:
          "Notifications, launch readiness, and admin audit surfaces prove operating decisions are recoverable.",
  ...
  zh: {
    ...
    body: "\u8fd9\u662f\u7ed9\u5ba2\u6237\u770b\u7684\u95ed\u73af\u8bc1\u660e\u8def\u5f84\u3002\u6bcf\u4e2a\u9636\u6bb5\u90fd\u4ece\u73b0\u6709\u5de5\u4f5c\u53f0\u3001\u6ce8\u518c\u8868\u3001\u5ba1\u6838\u3001\u8fd0\u884c\u3001\u8d26\u672c\u3001\u63d0\u73b0\u3001\u901a\u77e5\u548c\u4e0a\u7ebf\u5c31\u7eea\u72b6\u6001\u63a8\u5bfc\uff0c\u4e0d\u9020\u5047\u4efb\u52a1\u5217\u8868\u3002",
    bottleneck: "\u4e0b\u4e00\u4e2a\u74f6\u9888",
    eyebrow: "P0 \u8fd0\u8425\u8bc1\u660e",
    summary: {
      attention: "\u9700\u5173\u6ce8",
    ...
    steps: {
      publish: {
        detail:
          "\u53d1\u5e03\u8005\u4f9b\u7ed9\u4ece\u7ec4\u7ec7\u8303\u56f4\u8349\u7a3f\u6216\u81ea\u6709\u6280\u80fd\u72b6\u6001\u5f00\u59cb\u3002",
        next: "\u4ece\u53d1\u5e03\u5165\u53e3\u5f00\u59cb",
        title: "\u53d1\u5e03\u8005\u4e0a\u4f20",
      },
      checks: {
        detail:
          "\u7cbe\u786e\u7248\u672c\u5e26\u6709\u5ba1\u6838 SLA \u548c manifest/runtime/example/security \u81ea\u52a8\u68c0\u67e5\u8bc1\u636e\u3002",
        next: "\u4fee\u590d\u6216\u63d0\u4ea4\u7248\u672c",
        title: "\u7248\u672c\u63d0\u4ea4\u4e0e\u68c0\u67e5",
      },
      review: {
      ...
      listing: {
        detail:
          "\u516c\u5f00\u4e0a\u67b6\u628a\u5df2\u5ba1\u6838\u4f9b\u7ed9\u8fde\u5230\u53d1\u73b0\u3001\u4ef7\u683c\u3001\u53cd\u9988\u548c\u53d1\u5e03\u8005\u4fe1\u4efb\u3002",
        next: "\u68c0\u67e5\u5e02\u573a",
        title: "\u5e02\u573a\u4e0a\u67b6",
      },
      install: {
        detail:
          "\u5f00\u53d1\u8005\u628a\u76ee\u5f55\u51b3\u7b56\u53d8\u6210\u7ec4\u7ec7\u9879\u76ee\u548c\u56fa\u5b9a\u7248\u672c\u5b89\u88c5\u72b6\u6001\u3002",
        next: "\u6253\u5f00\u5f00\u53d1\u8005\u9879\u76ee",
        title: "\u5f00\u53d1\u8005\u5b89\u88c5",
      },
      runtime: {
        detail:
          "\u9879\u76ee Key\u3001\u7b56\u7565\u3001\u9884\u7b97\u3001\u8ba2\u9605\u95e8\u69db\u3001REST\u3001MCP \u548c\u63a7\u5236\u53f0\u6d4b\u8bd5\u5171\u7528\u540c\u4e00\u8fd0\u884c\u8def\u5f84\u3002",
        next: "\u6253\u5f00\u8fd0\u884c\u6307\u6325\u53f0",
        title: "\u7b56\u7565\u3001Key \u4e0e\u8fd0\u884c\u6d4b\u8bd5",
      },
      money: {
        detail:
          "\u53ef\u8ba1\u8d39\u7528\u91cf\u548c\u8ba2\u9605\u5e94\u4ea7\u751f\u4e0d\u53ef\u53d8\u4ea4\u6613\u3001\u5206\u8d26\u3001\u4f59\u989d\u548c\u63d0\u73b0\u5c31\u7eea\u3002",
        next: "\u590d\u6838\u8d26\u672c\u548c\u63d0\u73b0",
        title: "\u8d26\u672c\u4e0e\u63d0\u73b0",
      },
      readiness: {
        detail:
          "\u901a\u77e5\u3001\u4e0a\u7ebf\u5c31\u7eea\u548c\u540e\u53f0\u5ba1\u8ba1\u8868\u660e\u8fd0\u8425\u51b3\u7b56\u53ef\u6062\u590d\u3001\u53ef\u8ffd\u6eaf\u3002",
        next: "\u6253\u5f00\u540e\u53f0\u5c31\u7eea\u5ea6",
        title: "\u901a\u77e5\u3001\u5c31\u7eea\u3001\u5ba1\u8ba1",
      },
    },
...
export default async function DashboardPage({ searchParams }: PageProps) {
  ...
  const shellSecondaryHref = session.subject
    ? localizedHref("/account", locale)
    : undefined;
  const shellSecondaryLabel = session.subject
    ? locale === "zh"
      ? "个人中心"
      : "Account"
    : undefined;
          ...
          <section className="section">
            ...
            <div className="section-inner mt-6 flex items-center gap-3 flex-wrap">
              <a
                ...
                href={localizedHrefWithReturnTo("/login", locale, "/dashboard")}
              >
  ...
  const ledgerRows =
    financeLedger.recentTransactions.length > 0
      ? financeLedger.recentTransactions
          .slice(0, 5)
          .map((transaction) => [
      ...
      : [];
  const totalInstalledSkills = developerProjects.reduce(
    (sum, project) => sum + project.installs.installedSkillCount,
    0,
  );
  const totalRuntimeCalls = developerProjects.reduce(
    (sum, project) => sum + project.runtime.callCount,
    0,
  );
  const totalBillableCalls = developerProjects.reduce(
    (sum, project) => sum + project.usage.billableUsageCount,
    0,
  );
  const totalActiveSubscriptions = developerProjects.reduce(
    (sum, project) => sum + project.subscriptions.activeCount,
    0,
  );
  const verifiedPublisherSkills = publisherSkills.filter(
  ...
  const paidBlockerCount = publisherSkills.reduce(
    (sum, skill) => sum + (skill.commercial?.blockers.length ?? 0),
    0,
  );
  const launchIssueCount =
    launchReadiness.summary.blocker + launchReadiness.summary.warning;
  ...
  const automatedCheckCount = publisherSkills.reduce(
    (sum, skill) => sum + skill.runtime.checkCount,
    0,
  );
  const automatedCheckProblemCount = publisherSkills.reduce(
    (sum, skill) =>
      sum + skill.runtime.failedCount + skill.runtime.warningCount,
    0,
  );
  ...
  const activeProjectKeyCount = developerProjects.reduce(
    (sum, project) => sum + project.apiKeys.activeCount,
    0,
  );
  const ownerApprovalCount = developerProjects.reduce(
    (sum, project) =>
      sum +
      project.installs.ownerRequiredCount +
      project.policy.approvalRequiredCount,
    0,
  );
  const runtimeIssueCount = developerProjects.reduce(
    (sum, project) =>
      sum + project.runtime.errorCount + project.runtime.blockedCount,
    0,
  );
  const runtimeSuccessCount = developerProjects.reduce(
    (sum, project) => sum + project.runtime.successCount,
    0,
  );
  const payoutBlockerCount = payoutSummary.readiness?.blockers.length ?? 0;
  const activePayoutWork = payoutSummary.payouts.filter(
    (payout) => payout.status !== "paid",
  ).length;
  const notificationIssueCount =
    userNotificationInbox.summary.failed +
    userNotificationInbox.summary.skipped;
  const primaryProject =
    developerProjects.find(
      (project) => project.installs.installedSkillCount > 0,
    ) ?? developerProjects[0];
  const projectRuntimeHref = primaryProject
    ? `/dashboard/projects/${primaryProject.slug}`
    : "/developer";
  const roleSet = dashboardRoleSet(session);
  const canUseDeveloper = hasDashboardRole(roleSet, [
    "developer",
    "owner",
    "admin",
    "super_admin",
  ]);
  const canUsePublisher = hasDashboardRole(roleSet, [
    "publisher",
    "owner",
    "admin",
    "super_admin",
  ]);
  const canUseAdmin = hasDashboardRole(roleSet, [
    "reviewer",
    "finance",
    "support",
    "admin",
  ...
  const visibleMetrics = [
    ...
    [
      labels.metrics[1][0],
      formatMoney(financeLedger.summary.pendingBalanceCents),
    ],
  ...
  const dashboardCommandCards = [
    {
      ...
      nextAction: session.subject
        ? commandLabels.cards.account.nextSignedIn
        : commandLabels.cards.account.nextSignedOut,
      requiredRoles: [] as string[],
      role: commandLabels.cards.account.role,
      signal: session.subject
        ? (session.subject.displayName ??
          session.subject.email ??
          commandLabels.status.available)
    ...
    },
    {
      ...
      nextAction:
        developerProjects.length > 0
          ? commandLabels.cards.developer.nextReady
          : commandLabels.cards.developer.nextEmpty,
    ...
    },
    {
      ...
      nextAction:
        publisherSkills.length > 0
          ? commandLabels.cards.publisher.nextReady
          : commandLabels.cards.publisher.nextEmpty,
    ...
    },
    {
      ...
      nextAction:
        launchIssueCount > 0
          ? commandLabels.cards.admin.nextIssues
          : commandLabels.cards.admin.nextClear,
  ...
  const demoChainSteps: DemoChainStep[] = [
    ...
    },
    {
      ...
      status:
        automatedCheckProblemCount > 0
          ? "attention"
          : submittedVersionCount > 0 && automatedCheckCount > 0
            ? "ready"
            : "waiting",
    ...
    },
    {
      ...
      status:
        verifiedPublisherSkills > 0
          ? "ready"
          : publisherReviewWork > 0
            ? "attention"
            : "waiting",
    ...
    },
    {
      ...
      status:
        launchIssueCount > 0 || notificationIssueCount > 0
          ? "attention"
          : userNotificationInbox.summary.total > 0 ||
              launchReadiness.summary.ready > 0
            ? "ready"
            : "waiting",
  ...
  const demoChainBottleneck =
    demoChainSteps.find((step) => step.status !== "ready") ?? null;

  const heroMetrics = visibleMetrics.slice(0, 3);
  const overviewPanel = (
    <>
      <div className="dashboard-tab-heading">
        <div>
          <h2>{commandLabels.eyebrow}</h2>
          <p>
            {locale === "zh"
              ? "角色入口和 P0 演示链路集中在这里，具体操作进入对应 tab。"
              : "Role entry points and the P0 demo chain stay here; detailed work lives in the role tabs."}
          </p>
        </div>
        <div className="dashboard-tab-heading__stats" aria-label={commandLabels.eyebrow}>
          <span>
            {commandLabels.proof.journeys}
            <strong>3</strong>
          </span>
          <span>
            {commandLabels.proof.paidBlockers}
            <strong>{formatCompactNumber(paidBlockerCount)}</strong>
          </span>
          <span>
            {commandLabels.proof.runtimeCalls}
      ...
      <div className="dashboard-role-grid">
        {dashboardCommandCards.map((card) => {
          ...
          const access = getDashboardCommandState(
            card.requiredRoles,
            session,
            commandLabels,
          );
          ...
          const needsAttention =
            ...
            (card.key === "publisher" &&
              (publisherReviewWork > 0 || paidBlockerCount > 0));

          return (
            <article className="card dashboard-role-card" key={card.key} title={card.description}>
              <div className="dashboard-role-card__head">
                <span className="dashboard-role-card__icon">
                  <Icon size={18} aria-hidden="true" />
                </span>
                <span
                  className={
                    access.kind === "available" ? "pill" : "pill pill--warning"
                  }
                >
                  {needsAttention && access.kind === "available"
                    ? commandLabels.status.needsWork
                    : access.label}
                </span>
              </div>
              <span className="dashboard-role-card__role">{card.role}</span>
              <strong>{card.title}</strong>
              <div className="dashboard-role-card__metric">
      ...
      <div className="dashboard-demo-summary" id="p0-demo-chain">
        <div className="dashboard-tab-heading dashboard-tab-heading--compact">
          <div>
            <h2>{demoChainLabels.eyebrow}</h2>
            <p>{demoChainLabels.title}</p>
          </div>
          <div className="dashboard-tab-heading__stats" aria-label={demoChainLabels.eyebrow}>
            <span>
              {demoChainLabels.summary.ready}
              <strong>{demoChainSummary.ready}/8</strong>
            </span>
            <span>
              {demoChainLabels.summary.attention}
              <strong>{demoChainSummary.attention}</strong>
            </span>
            <span>
              {demoChainLabels.summary.waiting}
              <strong>{demoChainSummary.waiting}</strong>
            </span>
          </div>
        </div>

        <ol className="dashboard-chain-list">
          {demoChainSteps.map((step, index) => {
            const Icon = step.icon;

            return (
              <li className="dashboard-chain-row" key={step.id} title={`${step.detail} ${step.evidence}`}>
                <a href={localizedHref(step.href, locale)}>
                  <span className="dashboard-chain-row__index">
                    {String(index + 1).padStart(2, "0")}
                  </span>
                  <span className={`dashboard-chain-row__icon dashboard-chain-row__icon--${step.status}`}>
                ...
                <details>
                  <summary>{locale === "zh" ? "证据" : "Evidence"}</summary>
                  <p>{step.detail}</p>
                  <p>{step.evidence}</p>
                </details>
              </li>
        ...
        <div className="dashboard-bottleneck-row">
          <span>{demoChainLabels.bottleneck}</span>
          <strong>
            {demoChainBottleneck
              ? demoChainBottleneck.title
              : demoChainLabels.allClear}
          </strong>
  ...
  const developerPanel = (
    <>
      <div className="dashboard-tab-heading dashboard-tab-heading--compact">
        <div>
          <h2>{locale === "zh" ? "开发者工作区" : "Developer workspace"}</h2>
          <p>
            {locale === "zh"
              ? "创建项目、查看项目控制，并处理开发者侧买方需求。"
              : "Create projects, review project controls, and handle developer-side buyer requests."}
          </p>
        </div>
      </div>
      ...
      {canUseDeveloper ? (
        <div className="dashboard-panel-stack">
          <article className="card">
            ...
            <div className="mt-4 overflow-x-auto dashboard-data-table">
              ...
              {developerProjectRows.map((project) => (
                <div
                  className="grid grid-cols-4 gap-2 py-2 border-b border-[rgba(255,255,255,0.08)]"
                  key={project.slug}
                >
                  <strong>
                    <a
                      className="underline"
                      href={localizedHref(`/dashboard/projects/${project.slug}`, locale)}
                    >
                      {project.name}
                    </a>
                  </strong>
              ...
              {developerProjectRows.length === 0 ? (
                <div className="py-3 text-sm text-[#999]">
                  {locale === "zh" ? "暂无开发者项目。" : "No developer projects yet."}
                </div>
              ) : null}
            </div>
          </article>
        ...
        <WorkspaceLockedCard
          body={
            locale === "zh"
              ? "当前账号没有开发者、负责人或管理员角色。"
              : "This account does not have developer, owner, or admin access."
          }
          ctaHref="/account"
  ...
  const publisherPanel = (
    <>
      <div className="dashboard-tab-heading dashboard-tab-heading--compact">
        <div>
          <h2>{locale === "zh" ? "发布者工作区" : "Publisher workspace"}</h2>
          <p>
            {locale === "zh"
              ? "管理技能、审核修复、付费准备和发布者侧买方需求。"
              : "Manage skills, review repair, paid readiness, and publisher-side buyer requests."}
          </p>
        </div>
      </div>
      ...
      {canUsePublisher ? (
        ...
        <WorkspaceLockedCard
          body={
            locale === "zh"
              ? "当前账号没有发布者、负责人或管理员角色。"
              : "This account does not have publisher, owner, or admin access."
          }
          ctaHref="/account"
          ctaLabel={locale === "zh" ? "检查账号角色" : "Check account roles"}
          locale={locale}
  ...
  const financePanel = (
    <>
      <div className="dashboard-tab-heading dashboard-tab-heading--compact">
        <div>
          <h2>{locale === "zh" ? "财务与账单" : "Finance and billing"}</h2>
          <p>
            {locale === "zh"
              ? "按权限显示账本、收款资料、提现、组织账单和调整记录。"
              : "Ledger, accounts, payouts, organization billing, and adjustments appear by role."}
          </p>
        </div>
      </div>

      {canUsePublisher || canUseAdmin || canUseDeveloper ? (
        <div className="dashboard-finance-grid">
          {canUsePublisher || canUseAdmin ? (
            <article className="card dashboard-finance-grid__wide">
              <div className="eyebrow mb-4 flex items-center gap-2">
                <CircleDollarSign size={16} aria-hidden="true" />
                <span>{labels.ledgerTitle}</span>
              </div>
              <div className="overflow-x-auto dashboard-data-table">
                ...
                {ledgerRows.length > 0 ? (
                  ledgerRows.map(([skill, gross, fee, net, status]) => (
                    <div
                      className="grid grid-cols-5 gap-2 py-2 border-b border-[rgba(255,255,255,0.08)]"
                      key={skill}
                    >
                      <strong>{skill}</strong>
                      <span>{gross}</span>
        ...
        <WorkspaceLockedCard
          body={
            locale === "zh"
              ? "收入、分账、退款、争议和组织账单会按角色显示。"
              : "Revenue, splits, refunds, disputes, and organization billing appear by role."
          }
          ctaHref="/account"
          ctaLabel={locale === "zh" ? "检查账号角色" : "Check account roles"}
          locale={locale}
  ...
  const notificationsPanel = (
    <>
      <div className="dashboard-tab-heading dashboard-tab-heading--compact">
        <div>
          <h2>{locale === "zh" ? "通知与运行状态" : "Notifications and runtime"}</h2>
          <p>
            {locale === "zh"
              ? "处理通知收件箱、偏好和紧凑运行 API 状态。"
              : "Manage the inbox, preferences, and compact runtime API state."}
          </p>
        </div>
      </div>
      ...
      <div className="dashboard-notification-grid">
        ...
        />
        <article className="card dashboard-notification-grid__wide">
          <div className="eyebrow mb-4 flex items-center gap-2">
      ...
      <div className={styles.pageStyles}>
        <section className="dashboard-hero">
          <div className="dashboard-hero__copy">
            ...
            <p>
              {locale === "zh"
                ? "按角色切换工作区，保留项目、发布、财务和通知的真实操作入口。"
                : "Switch by role while keeping project, publishing, finance, and notification actions in one place."}
            </p>
          </div>
          <div className="dashboard-hero__metrics" aria-label={labels.eyebrow}>
...
type DashboardCommandCopy =
  | (typeof dashboardCommandCopy)["en"]
  | (typeof dashboardCommandCopy)["zh"];

function getDashboardCommandState(
  requiredRoles: string[],
  session: WorkspaceSession,
  labels: DashboardCommandCopy,
) {
  if (!session.subject) {
    return {
...
function getDashboardCommandHref(
  href: string,
  state: "available" | "blocked" | "forbidden",
) {
  if (state === "blocked") {
    return "/login";
  }
...
function formatLedgerStatus(value: string, ops: DashboardOpsCopy) {
  return (
    ops.ledgerStatuses[value as keyof typeof ops.ledgerStatuses] ??
    value.replaceAll("_", " ")
  );
}
...
function formatProjectPolicyState(value: string, ops: DashboardOpsCopy) {
  return (
    ops.projectPolicyStates[value as keyof typeof ops.projectPolicyStates] ??
    value.replaceAll("_", " ")
  );
}
...
function formatRefundStatus(value: string, ops: DashboardOpsCopy) {
  return (
    ops.refundStatuses[value as keyof typeof ops.refundStatuses] ??
    value.replaceAll("_", " ")
  );
}
...
function formatDisputeStatus(value: string, ops: DashboardOpsCopy) {
  return (
    ops.disputeStatuses[value as keyof typeof ops.disputeStatuses] ??
    value.replaceAll("_", " ")
  );
}
