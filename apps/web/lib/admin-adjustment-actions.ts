...
const copy = {
  en: {
    ...
    missingToken: "Sign in with a finance/admin token or configure SKILLHUB_ADMIN_TOKEN before handling refunds and disputes.",
  ...
  zh: {
    ...
    missingToken: "请先用财务或管理员 token 登录，或配置 SKILLHUB_ADMIN_TOKEN，才能处理退款和争议。",
