...
const copy = {
  en: {
    ...
    missingToken: "Sign in with an owner/admin user token or configure a workspace fallback before managing team access.",
  ...
  zh: {
    ...
    missingToken: "请先用 owner/admin 用户 token 登录，或配置工作区兜底 token，才能管理团队权限。",
