...
export function getPublicSkillActionState(
  ...
  return {
    ...
    summary: {
      en: "Verified review is complete. Project adoption and runtime actions write authenticated project state and remain governed by project policy, budget, and key checks.",
